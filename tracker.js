...
function WeeklyView({
  ...
  const generaConfronto = async () => {
    ...
    const prompt = "Sei un analista marketing esperto di ComparaSemplice.it. Devi confrontare due settimane di performance del tracker CS Energia e scrivere un'analisi narrativa di 3 paragrafi (max 150 parole totali).\n\n" + "Tono: analista freddo e preciso, zero retorica, zero complimenti. Usa i numeri per ancorare ogni affermazione.\n\n" + "Struttura obbligatoria:\n" + "- Paragrafo 1: volumi e produttività (lead, ore, LAV/ORA) — confronto quantitativo\n" + "- Paragrafo 2: economics (CPA, CPL, RED, margine) — identifica driver principali di miglioramento/peggioramento\n" + "- Paragrafo 3: macrofornitori salienti (solo i 2-3 più rilevanti per volume o variazione) + nota positiva se presente\n\n" + "Regole:\n" + "- Non ripetere tutti i numeri in tabella, seleziona quelli che raccontano la storia\n" + "- Se un valore è null/mancante, ometti\n" + "- Niente emoji, niente bullet, solo prosa\n" + "- Esprimi in italiano\n\n" + "SETTIMANA CORRENTE: " + JSON.stringify(corrente) + "\n\n" + "SETTIMANA PRECEDENTE: " + JSON.stringify(precedente);
    try {
      const res = await fetch("https://cs-energia-proxy.roberta-esposito.workers.dev", {
        method: "POST",
        headers: {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
  ...
  }, "\u2014 Timing 1-5 min \u2014 Fasce fuori range (media settimana) \u2014"), tuteFasceFuoriRange.length > 0 ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: "2px",
    ...
    const dot = isOver ? "🔴" : "🟠";
    const leadsStr = f.leadsEff !== null && f.tobe !== null ? " · " + Math.round(f.leadsEff) + " lead/gg vs " + Math.round(f.tobe) + " TO BE" : "";
    return /*#__PURE__*/React.createElement("div", {
      key: f.h,
      style: {
        display: "flex",
  ...
  }, "\u2713 Tutte le fasce orarie in range 90-97,99%")), /*#__PURE__*/React.createElement("div", {
    style: cardCss
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      ...secCss,
  ...
  }, "Pattern mese (da ultimo record giornaliero disponibile", latestRecWithMese ? ": " + latestRecWithMese.date : "", ")"), hasPatternMese ? /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: "13px",
      color: "#c4b8e3",
      lineHeight: "1.8"
    }
  }, patternMeseOver.length > 0 && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("strong", {
    style: {
      color: "#ff6b6b"
    }
  }, "Over-generazione cronica (ridurre):"), " fasce ", patternMeseOver.map(f => f.h + ":00 (" + f.v + "%)").join(", "), patternMeseUnder.length > 0 && /*#__PURE__*/React.createElement("br", null)), patternMeseUnder.length > 0 && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("strong", {
    style: {
      color: "#FD6F3B"
    }
  ...
  }, "\u2713 Nessuna fascia strutturalmente fuori range nel mese") : /*#__PURE__*/React.createElement("div", {
    style: {
      padding: "14px",
      textAlign: "center",
      color: "#8a7ca8",
  ...
  }, "Pattern mese non disponibile (nessun record giornaliero con hourlyMese)")), /*#__PURE__*/React.createElement("div", {
    style: cardCss
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      ...secCss,
  ...
  }, "Confronto non ancora generato. Premi \"\u21BB Rigenera\" per crearlo.")), /*#__PURE__*/React.createElement("div", {
    style: cardCss
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      ...secCss,
  ...
  }, "\u0394 vs TO BE"), /*#__PURE__*/React.createElement("th", {
    style: {
      textAlign: "right",
      padding: "6px 8px",
      fontSize: "10px",
  ...
  }, "Fase 2 completata"), " \u2014 Dati caricati e salvati. Le prossime fasi attiveranno:", /*#__PURE__*/React.createElement("br", null), "\u2022 Sezione Timing con fasce fuori range (Fase 3)", /*#__PURE__*/React.createElement("br", null), "\u2022 Tabella Azioni correttive con Marg./lead e Indicazione (Fase 4)", /*#__PURE__*/React.createElement("br", null), "\u2022 Confronto discorsivo tra settimane (Fase 5)"));
}
function App() {
...
Rispondi in italiano, in modo diretto e operativo. Se mancano dati, indica esattamente quali e da quale dashboard recuperarli.`;
  ...
  const renderLogin = () => /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      maxWidth: "440px",
      width: "100%",
      boxShadow: "0 10px 40px rgba(102,76,205,0.25)"
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: "13px",
  ...
  }, "CS Energia Tracker"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: "14px",
      color: "#9d93c2",
      marginBottom: "28px"
    }
  }, "Inserisci la password del team per accedere."), /*#__PURE__*/React.createElement("input", {
    type: "password",
    value: loginPwd,
  ...
  }, loginLoading ? "Verifica in corso..." : "Accedi"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: "12px",
      color: "#6b6591",
      marginTop: "20px",
  ...
  }, "Logout")), renderNav(), view === "form" && renderForm(), view === "report" && renderReport(), view === "mese" && renderMese(), view === "history" && renderHistory(), view === "macro" && renderMacro());
}
