...
function TobePlanningUpload({
  ...
  const extractTobe = async () => {
    ...
    try {
      ...
      imgContent.push({
        type: "text",
        text: `Sei un assistente che legge pianificazioni lead generation da screenshot di Google Sheets.
...
Rispondi SOLO con il JSON.`
  ...
  }, "Carica uno screenshot della pianificazione (Google Sheets) per aggiornare il TO BE orario e le ore dichiarate dalla data indicata."), /*#__PURE__*/React.createElement("label", {
    style: {
      display: "block",
  ...
  }, "PNG o JPG del Google Sheets con tot leads e # ore per fascia"), /*#__PURE__*/React.createElement("input", {
    type: "file",
    accept: "image/*",
    onChange: e => {
