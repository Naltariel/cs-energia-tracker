...
- Altrimenti se CPA giorno > €115 → "un CPA di €[X] sopra target del [delta]% (critico)", dove delta si calcola come: Math.round(((CPA_giorno - 100) / 100) * 100). Esempio: CPA=122 → delta = round((122-100)/100*100) = 22 → "sopra target del 22%". NON usare altri valori di riferimento, usa SEMPRE il target fisso di €100.
