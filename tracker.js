  ...
  const buildCtx = () => {
    ...
    ranked.forEach((name, i) => {
      ...
      if (cappato) {
        ...
        // CPA ottimale ma fornitore under-genera: portare al TO BE
...
"[NOME]: ieri ha registrato [DICHIARAZIONE_CPA]. Trend CPA ultimi 3 giorni: [DIREZIONE_LEGGIBILE], media €[MEDIA_CPA_3GG]. Azione: portare la generazione al TO BE."
