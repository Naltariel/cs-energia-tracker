...
Rispondi in italiano, in modo diretto e operativo. Se mancano dati, indica esattamente quali e da quale dashboard recuperarli.`;
  ...
  const renderHistory = () => {
    // Calcola l'ultima settimana completa lun-sab
    const today = new Date();
    const dow = today.getDay(); // 0=dom, 1=lun, ..., 6=sab
    // Giorni da sottrarre per arrivare al lunedì della settimana corrente
    const daysToMon = dow === 0 ? 6 : dow - 1;
    const thisMon = new Date(today);
    thisMon.setDate(today.getDate() - daysToMon);
    thisMon.setHours(0, 0, 0, 0);
    // Ultima settimana completa: lunedì precedente
    const lastCompleteMon = new Date(thisMon);
    lastCompleteMon.setDate(thisMon.getDate() - 7);
    const lastCompleteSat = new Date(lastCompleteMon);
    lastCompleteSat.setDate(lastCompleteMon.getDate() + 5);
    const fmt = d => {
    ...
    // Genera label per le settimane disponibili (ultime 5)
    const weekOptions = [];
    for (let w = 0; w < 5; w++) {
      const mon = new Date(lastCompleteMon);
      mon.setDate(lastCompleteMon.getDate() - w * 7);
      const sat = new Date(mon);
      sat.setDate(mon.getDate() + 5);
      const label = fmt(mon) + '-' + fmt(sat);
      weekOptions.push({
        label,
        mon,
        sat,
    ...
    // Aggiungo anche settimana corrente parziale
    const thisSat = new Date(thisMon);
    thisSat.setDate(thisMon.getDate() + 5);
    const currentWeekLabel = fmt(thisMon) + '-' + fmt(thisSat);
    return /*#__PURE__*/React.createElement("div", {
      style: {
        padding: "28px",
        maxWidth: "1400px",
    ...
    }, "Sett. corrente ", currentWeekLabel, " (parziale)"), weekOptions.map((w, idx) => /*#__PURE__*/React.createElement("button", {
      key: idx,
      style: {
        padding: "8px 14px",
        background: w.isCurrent ? P : "transparent",
        border: "1px solid " + (w.isCurrent ? P : BD),
        color: w.isCurrent ? "#fff" : "#c4b8e3",
        borderRadius: "6px",
        fontSize: "12px",
        cursor: "pointer"
      }
    }, w.label, idx === 0 ? " (ultima completa)" : "")), /*#__PURE__*/React.createElement("button", {
      style: {
        padding: "8px 14px",
        background: O,
        border: "none",
    ...
    }, "+ Carica settimana"))), /*#__PURE__*/React.createElement("div", {
      style: {
        padding: "14px",
    ...
    }, "FASE 1 \u2014 Struttura base"), /*#__PURE__*/React.createElement("br", null), "Il Report Settimana \xE8 in ricostruzione. Struttura e selettore settimana pronti. Nella prossima fase verr\xE0 attivato il caricamento dati (screenshot Power BI settimanali, TO BE sabato, ARPU) e l'estrazione AI."), /*#__PURE__*/React.createElement("div", {
      style: cardCss
    }, /*#__PURE__*/React.createElement("div", {
      style: {
        ...secCss,
    ...
    }, "KPI Settimana ", weekOptions[0].label), /*#__PURE__*/React.createElement("div", {
      style: {
        padding: "40px",
        textAlign: "center",
        color: "#8a7ca8",
    ...
    }, "Dati da caricare \u2014 premi ", /*#__PURE__*/React.createElement("strong", {
      style: {
        color: O
      }
    }, "+ Carica settimana"), " per estrarre da screenshot Power BI.")), /*#__PURE__*/React.createElement("div", {
      style: cardCss
    }, /*#__PURE__*/React.createElement("div", {
      style: {
        ...secCss,
    ...
    }, "\u2014 Timing 1-5 min \u2014 Fasce fuori range (media settimana) \u2014"), /*#__PURE__*/React.createElement("div", {
      style: {
        padding: "40px",
        textAlign: "center",
        color: "#8a7ca8",
    ...
    }, "Dati da caricare")), /*#__PURE__*/React.createElement("div", {
      style: cardCss
    }, /*#__PURE__*/React.createElement("div", {
      style: {
        ...secCss,
    ...
    }, "\u2014 Macrofornitori settimana \u2014"), /*#__PURE__*/React.createElement("div", {
      style: {
        padding: "40px",
        textAlign: "center",
        color: "#8a7ca8",
    ...
    }, "Azioni correttive \u2014 Tabella Margine/Lead"), /*#__PURE__*/React.createElement("div", {
      style: {
        padding: "40px",
        textAlign: "center",
        color: "#8a7ca8",
    ...
    }, "Confronto settimane"), /*#__PURE__*/React.createElement("div", {
      style: {
        padding: "40px",
        textAlign: "center",
        color: "#8a7ca8",
