...
function WeeklyView({
  ...
  }, sabato ? sabato.lead.toLocaleString() : "non impostato")), /*#__PURE__*/React.createElement("tr", null, /*#__PURE__*/React.createElement("td", {
    colSpan: "2",
    style: {
      padding: "6px 0",
  ...
  }, sabato ? sabato.ore.toLocaleString() : "non impostato")), sabato && satLeadEff !== null && /*#__PURE__*/React.createElement("tr", null, /*#__PURE__*/React.createElement("td", {
    colSpan: "2",
    style: {
      paddingTop: "12px",
      fontSize: "11px",
  ...
  }, "Delta lead: ", /*#__PURE__*/React.createElement("span", {
    style: {
      color: satLeadEff >= sabato.lead ? "#6bcf5e" : "#ff6b6b"
    }
  }, satLeadEff >= sabato.lead ? "+" : "", ((satLeadEff - sabato.lead) / sabato.lead * 100).toFixed(1), "%"))))))), /*#__PURE__*/React.createElement("div", {
    style: cardCss
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      ...secCss,
...
Rispondi in italiano, in modo diretto e operativo. Se mancano dati, indica esattamente quali e da quale dashboard recuperarli.`;
  ...
  const renderHistory = () => {
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, "Sett. corrente ", fmtDD(currentWeek.mon) + "-" + fmtDD(currentWeek.sat), " (parziale)"), weekOptions.map((w, idx) => {
      ...
      }, fmtDD(w.mon) + "-" + fmtDD(w.sat), idx === 0 ? " (ultima completa)" : "", hasData && /*#__PURE__*/React.createElement("span", {
        style: {
          marginLeft: "6px",
          color: "#6bcf5e",
          fontSize: "11px"
    ...
    }), settRecord ? /*#__PURE__*/React.createElement(WeeklyView, {
      record: settRecord,
      tobeSabati: tobeSabati,
      records: records,
    ...
    }, "Nessun dato per questa settimana"), /*#__PURE__*/React.createElement("br", null), "Premi ", /*#__PURE__*/React.createElement("strong", {
      style: {
        color: O
      }
    }, "+ Carica settimana"), " per estrarre i dati dagli screenshot Power BI."), /*#__PURE__*/React.createElement("div", {
      style: cardCss
    }, /*#__PURE__*/React.createElement("div", {
      style: {
        ...secCss,
    ...
    }, "KPI Settimana ", fmtDD(activeWeek.mon) + "-" + fmtDD(activeWeek.sat)), /*#__PURE__*/React.createElement("div", {
      style: {
        padding: "40px",
        textAlign: "center",
        color: "#8a7ca8",
