...
function WeeklyView({ record, tobeSabati, records, activeWeek }) {
  ...
  const avgLeadGg = daysInRange.length > 0
    ? Math.round(daysInRange.reduce((s, r) => s + (parseInt(r.leadGen) || 0), 0) / daysInRange.length)
    : null;
  const avgOreGg = daysInRange.length > 0
    ? Math.round(daysInRange.reduce((s, r) => s + (parseFloat(r.ore) || 0), 0) / daysInRange.length)
    : null;
    ...
    <>
      <div style={cardCss}>
        <div style={{ ...secCss, color: P, marginBottom: "12px" }}>
          KPI Settimana {fmtDDMM(activeWeek.mon)}-{fmtDDMM(activeWeek.sat)} (6 giorni lun-sab)
        </div>
        <div style={{ fontSize: "11px", color: "#8a7ca8", marginBottom: "12px" }}>
          Lead/Ore da media giornaliera · Altri KPI da screenshot settimanale · ARPU: €{record.arpu}
        </div>
        <table style={{ width: "100%", borderCollapse: "collapse" }}>
          <thead>
            <tr style={{ borderBottom: "1px solid " + BD }}>
              <th style={{ textAlign: "left", padding: "8px", fontSize: "10px", color: "#8a7ca8", textTransform: "uppercase", letterSpacing: "1px" }}>KPI</th>
              <th style={{ textAlign: "left", padding: "8px", fontSize: "10px", color: "#8a7ca8", textTransform: "uppercase", letterSpacing: "1px" }}>Valore settimana</th>
              <th style={{ textAlign: "left", padding: "8px", fontSize: "10px", color: "#8a7ca8", textTransform: "uppercase", letterSpacing: "1px" }}>Target</th>
            </tr>
          </thead>
          <tbody>
            <tr><td style={{ padding: "10px 8px", color: O, fontWeight: 500, fontSize: "13px" }}>LEAD GENERATE / gg</td>
                <td style={{ padding: "10px 8px", color: "#fff", fontWeight: 600, fontSize: "15px" }}>{avgLeadGg !== null ? avgLeadGg.toLocaleString() : "—"}</td>
                <td style={{ padding: "10px 8px", color: "#8a7ca8", fontSize: "12px" }}>{avgTobeLeadGg !== null ? avgTobeLeadGg.toLocaleString() + " TO BE" : "—"}</td></tr>
            <tr><td style={{ padding: "10px 8px", color: O, fontWeight: 500, fontSize: "13px" }}>ORE / gg</td>
                <td style={{ padding: "10px 8px", color: "#fff", fontWeight: 600, fontSize: "15px" }}>{avgOreGg !== null ? avgOreGg.toLocaleString() : "—"}</td>
                <td style={{ padding: "10px 8px", color: "#8a7ca8", fontSize: "12px" }}>{avgTobeOreGg !== null ? avgTobeOreGg + " dich." : "—"}</td></tr>
            <tr><td style={{ padding: "10px 8px", color: O, fontWeight: 500, fontSize: "13px" }}>LAV/ORA</td>
                <td style={{ padding: "10px 8px", color: "#fff", fontWeight: 600, fontSize: "15px" }}>{k.lavOra ?? "—"}</td>
                <td style={{ padding: "10px 8px", color: "#8a7ca8", fontSize: "12px" }}>2,53 target</td></tr>
            <tr><td style={{ padding: "10px 8px", color: O, fontWeight: 500, fontSize: "13px" }}>RED</td>
                <td style={{ padding: "10px 8px", color: "#fff", fontWeight: 600, fontSize: "15px" }}>{k.red != null ? k.red + "%" : "—"}</td>
                <td style={{ padding: "10px 8px", color: "#8a7ca8", fontSize: "12px" }}>17,0% target</td></tr>
            <tr><td style={{ padding: "10px 8px", color: O, fontWeight: 500, fontSize: "13px" }}>RESA</td>
                <td style={{ padding: "10px 8px", color: "#fff", fontWeight: 600, fontSize: "15px" }}>{k.resa ?? "—"}</td>
                <td style={{ padding: "10px 8px", color: "#8a7ca8", fontSize: "12px" }}>0,45 target</td></tr>
            <tr><td style={{ padding: "10px 8px", color: O, fontWeight: 500, fontSize: "13px" }}>% CTC</td>
                <td style={{ padding: "10px 8px", color: "#fff", fontWeight: 600, fontSize: "15px" }}>{k.ctc != null ? k.ctc + "%" : "—"}</td>
                <td style={{ padding: "10px 8px", color: "#8a7ca8", fontSize: "12px" }}>≥25% target</td></tr>
            <tr><td style={{ padding: "10px 8px", color: O, fontWeight: 500, fontSize: "13px" }}>TIMING 1-5min</td>
                <td style={{ padding: "10px 8px", color: "#fff", fontWeight: 600, fontSize: "15px" }}>{k.timing != null ? k.timing + "%" : "—"}</td>
                <td style={{ padding: "10px 8px", color: "#8a7ca8", fontSize: "12px" }}>90-97,99% range</td></tr>
            <tr><td style={{ padding: "10px 8px", color: O, fontWeight: 500, fontSize: "13px" }}>CONTATTAB. NETTO CTC</td>
                <td style={{ padding: "10px 8px", color: "#fff", fontWeight: 600, fontSize: "15px" }}>{k.contattab != null ? k.contattab + "%" : "—"}</td>
                <td style={{ padding: "10px 8px", color: "#8a7ca8", fontSize: "12px" }}>60% target</td></tr>
            <tr><td style={{ padding: "10px 8px", color: O, fontWeight: 500, fontSize: "13px" }}>CPL</td>
                <td style={{ padding: "10px 8px", color: "#fff", fontWeight: 600, fontSize: "15px" }}>{k.cpl != null ? k.cpl + "€" : "—"}</td>
                <td style={{ padding: "10px 8px", color: "#8a7ca8", fontSize: "12px" }}>12,5€ target</td></tr>
            <tr><td style={{ padding: "10px 8px", color: O, fontWeight: 500, fontSize: "13px" }}>CPA</td>
                <td style={{ padding: "10px 8px", color: "#fff", fontWeight: 600, fontSize: "15px" }}>{k.cpa != null ? k.cpa + "€" : "—"}</td>
                <td style={{ padding: "10px 8px", color: "#8a7ca8", fontSize: "12px" }}>100€ target</td></tr>
          </tbody>
        </table>
      </div>

      <div style={cardCss}>
        <div style={{ ...secCss, color: O, marginBottom: "12px" }}>— Macrofornitori settimana —</div>
        {record.macrofonti && record.macrofonti.length > 0 ? (
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            <thead>
              <tr style={{ borderBottom: "1px solid " + BD }}>
                <th style={{ textAlign: "left", padding: "8px", fontSize: "10px", color: "#8a7ca8" }}>Fornitore</th>
                <th style={{ textAlign: "right", padding: "8px", fontSize: "10px", color: "#8a7ca8" }}>Lead/gg</th>
                <th style={{ textAlign: "right", padding: "8px", fontSize: "10px", color: "#8a7ca8" }}>% tot</th>
                <th style={{ textAlign: "right", padding: "8px", fontSize: "10px", color: "#8a7ca8" }}>CPL</th>
                <th style={{ textAlign: "right", padding: "8px", fontSize: "10px", color: "#8a7ca8" }}>RED</th>
                <th style={{ textAlign: "right", padding: "8px", fontSize: "10px", color: "#8a7ca8" }}>CPA</th>
              </tr>
            </thead>
            <tbody>
              {record.macrofonti.map((m, idx) => (
                <tr key={idx} style={{ borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
                  <td style={{ padding: "9px 8px", color: "#fff", fontSize: "12px" }}>{m.name}</td>
                  <td style={{ padding: "9px 8px", color: "#fff", fontSize: "12px", textAlign: "right" }}>{m.leads || "—"}</td>
                  <td style={{ padding: "9px 8px", color: "#fff", fontSize: "12px", textAlign: "right" }}>{m.pct || "—"}%</td>
                  <td style={{ padding: "9px 8px", color: "#fff", fontSize: "12px", textAlign: "right" }}>{m.cpl ? "€" + m.cpl : "—"}</td>
                  <td style={{ padding: "9px 8px", color: "#fff", fontSize: "12px", textAlign: "right" }}>{m.red ? m.red + "%" : "—"}</td>
                  <td style={{ padding: "9px 8px", color: "#fff", fontSize: "12px", textAlign: "right" }}>{m.cpa ? "€" + m.cpa : "—"}</td>
                </tr>
              ))}
            </tbody>
          </table>
