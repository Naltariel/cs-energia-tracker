...
Rispondi SOLO con il JSON o "null", senza commenti, senza markdown.`;
      ...
      const [focusResa, focusOre, focusLavOra, focusTiming, focusRed, focusRedMese, focusResaMese, focusContattabMese, focusContattab, focusPressione, ...cpaResults] = await Promise.all([
