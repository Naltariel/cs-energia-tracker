...
function WeeklyLoadForm({ weekOptions, defaultWeekId, tobeSabati, recordsSett, records, onClose, onSaved }) {
  ...
  // Carica file Excel: parsing immediato + aggiunta a excelFiles (stesso pattern di QuickInsert)
  ...
  const handleExtractFromExcel = async () => {
    ...
    setExtractMsg("✓ Dati settimanali estratti da Excel e salvati.");
    setExtracting(false);
    ...
    <div style={{
      ...
      <div style={{ marginBottom: "16px", padding: "14px", background: "rgba(76,175,80,0.06)", border: "1px solid rgba(76,175,80,0.3)", borderRadius: "8px" }}>
        <div style={{ fontSize: "11px", color: "#6bcf5e", fontWeight: "bold", marginBottom: "8px", letterSpacing: "0.5px" }}>
          📊 EXCEL DA POWER BI <span style={{ color: "#8a7ca8", fontWeight: "normal" }}>(parsing deterministico, zero AI) — carica i 6 file settimanali (economics, contattab, timing, resa_net, ore, lavora)</span>
        </div>
        <input
          type="file"
          multiple
        ...
        <label htmlFor="weekly-excel-upload-input" style={{
          ...
          📂 Clicca per selezionare file Excel (.xlsx) — settimana lun-ven
        </label>
        {excelFiles.length > 0 && (
  ...
  return (
    <>
      <div style={{ display: "flex", gap: "18px", marginBottom: "18px", alignItems: "stretch" }}>
        <div style={{ ...cardCss, marginBottom: 0, flex: "1 1 75%" }}>
          ...
          <div style={{ fontSize: "11px", color: "#8a7ca8", marginBottom: "12px" }}>
            Lead/Ore = media giornaliera lun-ven · Altri KPI da screenshot settimanale · Delta vs settimana precedente · ARPU: €{record.arpu}
          </div>
      ...
      <div style={cardCss}>
        ...
        <div style={{ fontSize: "11px", color: "#8a7ca8", marginBottom: "14px" }}>
          Margine/lead = (ARPU − CPA) × RED · ARPU settimana: €{arpuSett != null ? arpuSett.toFixed(0) : "—"}
        </div>
        {macroRows.length > 0 ? (
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            <thead>
