...
function SintesiBox({ r, records, recordsSett, onSave }) {
  ...
  const buildCtx = () => {
    ...
    return [...kpi, "", ...fasceLines, "", "FASCE_FUORI_RANGE_ELENCO:", ...hourlyLines, "", ...sintesiFasceBlocco, "", ...patternLines, "", ...macroRankLinesDedup, "", ...azioniLinesNum, riallocLine].join("\n");
  };
...
function QuickInsert({ onSaved, onExtracted, records }) {
    ...
    <div style={{
      ...
      <div style={{ marginBottom: "12px" }}>
        <div style={{ fontSize: "11px", color: "#c4b8e3", fontWeight: "bold", marginBottom: "6px", letterSpacing: "0.5px" }}>
          📊 SCREEN SETTIMANALI <span style={{ color: "#8a7ca8", fontWeight: "normal" }}>(carica tutti gli screen, anche del sabato — Opus filtrerà)</span>
        </div>
        <input
          type="file"
          multiple
