        ...
        <table style={{ width: "100%", borderCollapse: "collapse" }}>
          ...
          <tbody>
            <tr><td style={{ padding: "5px 8px", color: O, fontWeight: 500, fontSize: "12px" }}>LEAD GENERATE / gg</td>
                ...
                <td style={{ padding: "5px 8px", color: "#8a7ca8", fontSize: "11px" }}>{avgTobeLeadGg !== null ? avgTobeLeadGg.toLocaleString() + " TO BE" : "—"}</td></tr>
            <tr><td style={{ padding: "5px 8px", color: O, fontWeight: 500, fontSize: "12px" }}>ORE / gg</td>
                ...
                <td style={{ padding: "5px 8px", color: "#8a7ca8", fontSize: "11px" }}>{avgTobeOreGg !== null ? avgTobeOreGg + " TO BE" : "—"}</td></tr>
            <tr><td style={{ padding: "5px 8px", color: O, fontWeight: 500, fontSize: "12px" }}>LAV/ORA</td>
                ...
                <td style={{ padding: "5px 8px", color: "#8a7ca8", fontSize: "11px" }}>2,53 target</td></tr>
            <tr><td style={{ padding: "5px 8px", color: O, fontWeight: 500, fontSize: "12px" }}>RED</td>
                ...
                <td style={{ padding: "5px 8px", color: "#8a7ca8", fontSize: "11px" }}>17,0% target</td></tr>
            <tr><td style={{ padding: "5px 8px", color: O, fontWeight: 500, fontSize: "12px" }}>RESA</td>
                ...
                <td style={{ padding: "5px 8px", color: "#8a7ca8", fontSize: "11px" }}>0,45 target</td></tr>
            <tr><td style={{ padding: "5px 8px", color: O, fontWeight: 500, fontSize: "12px" }}>% CTC</td>
                ...
                <td style={{ padding: "5px 8px", color: "#8a7ca8", fontSize: "11px" }}>≥25% target</td></tr>
            <tr><td style={{ padding: "5px 8px", color: O, fontWeight: 500, fontSize: "12px" }}>TIMING 1-5min</td>
                ...
                <td style={{ padding: "5px 8px", color: "#8a7ca8", fontSize: "11px" }}>90-97,99% range</td></tr>
            <tr><td style={{ padding: "5px 8px", color: O, fontWeight: 500, fontSize: "12px" }}>CONTATTAB. NETTO CTC</td>
                ...
                <td style={{ padding: "5px 8px", color: "#8a7ca8", fontSize: "11px" }}>60% target</td></tr>
            <tr><td style={{ padding: "5px 8px", color: O, fontWeight: 500, fontSize: "12px" }}>CPL</td>
                ...
                <td style={{ padding: "5px 8px", color: "#8a7ca8", fontSize: "11px" }}>12,5€ target</td></tr>
            <tr><td style={{ padding: "5px 8px", color: O, fontWeight: 500, fontSize: "12px" }}>CPA</td>
                ...
                <td style={{ padding: "5px 8px", color: "#8a7ca8", fontSize: "11px" }}>100€ target</td></tr>
          </tbody>
        </table>
        </div>
