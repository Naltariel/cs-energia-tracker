...
Rispondi SOLO con il numero o "null".`
      ...
      const [focusResa, focusOre, focusLavOra, focusTiming, focusRed, focusRedMese, focusResaMese, focusContattabMese, focusContattab, focusPressione] = await Promise.all([
