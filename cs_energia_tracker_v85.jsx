...
Rispondi in italiano, in modo diretto e operativo. Se mancano dati, indica esattamente quali e da quale dashboard recuperarli.`;
  ...
  const renderHistory = () => {
    ...
    for (let w = 0; w < 5; w++) {
      ...
      weekOptions.push({ label, mon, sat, isCurrent: w === 0 });
    }
    ...
    return (
      <div style={{ padding: "28px", maxWidth: "1400px", margin: "0 auto" }}>
        ...
        <div style={cardCss}>
          ...
          <div style={{ display: "flex", gap: "8px", flexWrap: "wrap", alignItems: "center" }}>
            <button style={{
              ...
              fontSize: "12px",
              cursor: "pointer"
            }}>Sett. corrente {currentWeekLabel} (parziale)</button>
        ...
        <div style={{
          ...
          <strong style={{color: O}}>FASE 1 — Struttura base</strong><br/>
          Il Report Settimana è in ricostruzione. Struttura e selettore settimana pronti. Nella prossima fase verrà attivato il caricamento dati (screenshot Power BI settimanali, TO BE sabato, ARPU) e l&apos;estrazione AI.
        </div>

        {/* KPI SETTIMANA — placeholder */}
        <div style={cardCss}>
          <div style={{ ...secCss, color: P, marginBottom: "12px" }}>KPI Settimana {weekOptions[0].label}</div>
          <div style={{ padding: "40px", textAlign: "center", color: "#8a7ca8", fontSize: "13px" }}>
            Dati da caricare — premi <strong style={{color: O}}>+ Carica settimana</strong> per estrarre da screenshot Power BI.
          </div>
        </div>

        {/* TIMING FASCE — placeholder */}
        <div style={cardCss}>
          <div style={{ ...secCss, color: O, marginBottom: "12px" }}>— Timing 1-5 min — Fasce fuori range (media settimana) —</div>
          <div style={{ padding: "40px", textAlign: "center", color: "#8a7ca8", fontSize: "13px" }}>
            Dati da caricare
          </div>
        </div>

        {/* MACROFORNITORI — placeholder */}
        <div style={cardCss}>
        ...
        {/* AZIONI CORRETTIVE — placeholder */}
        <div style={cardCss}>
          <div style={{ ...secCss, color: P, marginBottom: "12px" }}>Azioni correttive — Tabella Margine/Lead</div>
          <div style={{ padding: "40px", textAlign: "center", color: "#8a7ca8", fontSize: "13px" }}>
            Dati da caricare
          </div>
        </div>

        {/* CONFRONTO SETTIMANE — placeholder */}
        <div style={cardCss}>
          <div style={{ ...secCss, color: P, marginBottom: "12px" }}>Confronto settimane</div>
          <div style={{ padding: "40px", textAlign: "center", color: "#8a7ca8", fontSize: "13px" }}>
            Dati da caricare
          </div>
        </div>
