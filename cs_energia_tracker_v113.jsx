      ...
      <div style={{ display: "flex", gap: "18px", marginBottom: "18px", alignItems: "stretch" }}>
        ...
        <table style={{ width: "100%", borderCollapse: "collapse" }}>
          ...
          <tbody>
            ...
            <tr><td style={{ padding: "5px 8px", color: O, fontWeight: 500, fontSize: "12px" }}>DURATA MEDIA</td>
                <td style={{ padding: "5px 8px", color: "#fff", fontWeight: 600, fontSize: "13px" }}>{k.durataMedia != null ? k.durataMedia.toString().replace(".", ",") + " min" : "—"}</td>
                <td style={{ padding: "5px 8px", color: "#8a7ca8", fontSize: "11px" }}>—</td>
                <td style={{ padding: "5px 8px", color: "#8a7ca8", fontSize: "12px", textAlign: "right" }}>—</td></tr>
          </tbody>
        </table>
        </div>
