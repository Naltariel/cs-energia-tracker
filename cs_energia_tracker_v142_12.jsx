...
function SintesiBox({ r, records, recordsSett, onSave }) {
  ...
  const buildCtx = () => {
    ...
    return [...kpi, "", ...fasceLines, "", "FASCE_FUORI_RANGE_ELENCO:", ...hourlyLines, "", ...sintesiFasceBlocco, "", ...patternLines, "", ...macroRankLinesDedup, "", ...azioniLinesDedup, riallocLine].join("\n");
  };
...
- CRITICAL: ogni fornitore DEVE comparire UNA E UNA SOLA volta nella sezione Azioni. Conta i nomi e verifica che ognuno appaia esattamente 1 volta. Se nei DATI vedi solo "RUIU SOCIAL: ...", scrivi 1 sola riga "RUIU SOCIAL: ...". Se vedi solo "PAOLO SOCIAL: ...", scrivi 1 sola riga "PAOLO SOCIAL: ...". MAI scrivere due paragrafi per lo stesso nome.
...
- Il numero totale di righe in sezione Azioni correttive DEVE essere identico al numero di righe in sezione MACROFORNITORI (stesso numero di fornitori, stesso ordine, ognuno una sola volta)
