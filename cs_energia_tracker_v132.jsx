...
Rispondi SOLO con il JSON o "null", senza commenti, senza markdown, senza code block.`
        ...
        try {
          const messages = [{
            ...
            content: [
              ...
              { type: "text", text: prompts.macroCpa }
            ]
          }];
          const res = await fetch("https://cs-energia-proxy.roberta-esposito.workers.dev", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({ model: "claude-opus-4-7", max_tokens: 400, messages })
          });
      ...
      const [focusResa, focusOre, focusLavOra, focusTiming, focusRed, focusRedMese, focusResaMese, focusContattabMese, focusContattab, focusPressione, focusMacroCpa] = await Promise.all([
